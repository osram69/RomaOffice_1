...
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  const jsonLd = {
    ...
    description: lang === "it" ? "Uffici arredati e servizi di domiciliazione nel centro di Roma." : "Furnished offices and business domiciliation services in central Rome.",
    url: `${BASE_URL}${pathname}`, telephone: contact.phoneHref, email: contact.email,
    image: `${BASE_URL}/images/office-hero.jpg`, priceRange: "€€",

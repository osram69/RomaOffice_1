...
export type PageKind = "home" | "contact" | "legal" | "pricing" | "privacy" | "cookies" | "location" | "about" | "testimonials" | "service" | "rooms" | "secretary";
...
export const ui = {
  it: {
    ...
    home: "Home", offices: "Uffici", domiciliation: "Domiciliazione", pricing: "Tariffe", about: "Chi siamo", contact: "Contatti",
    activate: "ATTIVA ORA", call: "Chiama ora: 06 2111 6268", discover: "Scopri il servizio", details: "Dettagli",
  ...
  en: {
    ...
    home: "Home", offices: "Offices", domiciliation: "Domiciliation", pricing: "Pricing", about: "About", contact: "Contact",
    activate: "ACTIVATE NOW", call: "Call now: +39 06 21.11.6268", discover: "Discover the service", details: "Details",
...
export const services = {
  it: [
    ...
    { icon: "building", title: "Domiciliazione Sede Legale", text: "Una sede prestigiosa nel centro di Roma per società, professionisti e imprese.", href: "/domiciliazione-sede-legale.html" },
    { icon: "mail", title: "Domiciliazione Postale", text: "Ricezione, custodia e gestione professionale della tua corrispondenza.", href: "/domiciliazione-postale.html" },
  ...
  en: [
    ...
    { icon: "building", title: "Registered Office Domiciliation", text: "A prestigious central Rome address for companies, professionals and businesses.", href: "/en/legal-headquarters-domiliation.html" },
    { icon: "mail", title: "Postal Domiciliation", text: "Professional receipt, safekeeping and management of your business mail.", href: "/en/postal-domiliation.html" },
...
export type PageDef = { title: string; eyebrow: string; description: string; kind: PageKind; intro?: string; bullets?: string[] };
const itPages: Record<string, PageDef> = {
  ...
  "servizi-domiciliazione.html": { title: "Servizi di domiciliazione", eyebrow: "LA TUA SEDE A ROMA", description: "Scegli la soluzione più adatta alla tua attività.", kind: "service", bullets: ["Domiciliazione postale", "Sede legale", "Domiciliazione professionale e unità locale"] },
  ...
  "tariffe.html": { title: "Tariffe chiare, soluzioni flessibili", eyebrow: "PREZZI", description: "Configura il servizio e richiedi un preventivo personalizzato.", kind: "pricing" },
...
const translations: Record<string, PageDef> = {
  ...
  "en/domiliation-services.html": { title: "Domiciliation services", eyebrow: "YOUR ADDRESS IN ROME", description: "Choose the right solution for your organisation.", kind: "service", bullets: ["Postal domiciliation", "Registered office", "Professional and local-unit domiciliation"] },
  "en/postal-domiliation.html": { title: "Postal Domiciliation Rome", eyebrow: "BUSINESS MAIL", description: "Receive company mail at a prestigious, dependable address.", kind: "service", bullets: ["New-mail notifications", "Confidential safekeeping", "Collection or forwarding on request"] },
  ...
  "en/professional-domiliation.html": { title: "Professional domiciliation", eyebrow: "FOR PROFESSIONALS", description: "A professional address separate from your home, in the heart of Rome.", kind: "service", bullets: ["Use of professional address", "Mail management", "Credible business image"] },
  "en/sole-proprietorship-domiliation.html": { title: "Sole proprietorship domiciliation", eyebrow: "FOR ENTREPRENEURS", description: "A professional base for your sole proprietorship.", kind: "service", bullets: ["Business address", "Mail management", "Tailored add-on services"] },
  "en/local-unit-domiliation.html": { title: "Local unit domiciliation", eyebrow: "A PRESENCE IN ROME", description: "Open a Rome local unit with professional support.", kind: "service", bullets: ["Central Rome address", "Document support", "Workspaces on request"] },
  ...
  "en/pricing.html": { title: "Clear pricing, flexible options", eyebrow: "PRICING", description: "Configure your service and request a tailored quotation.", kind: "pricing" },
